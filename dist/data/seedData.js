...
async function seedDatabase() {
    try {
        // Clear existing data
        await MarketPrice_1.default.deleteMany({});
        ...
        await MarketPrice_1.default.insertMany(samplePrices);
        ...
        await Question_1.default.insertMany(sampleQuestions);
        ...
        await Listing_1.default.insertMany(sampleListings);
